...
if __name__ == "__main__":
    test_prompt_text = """Received data:  {'signal_value': 35.60000228881836, 'time_recorded': 2678.564299583435, 'caseid': 634, 'category': 'BT', 'reason': 'mild_range_violation'}
Received data:  {'signal_value': 26.0, 'time_recorded': 864.662, 'caseid': 634, 'category': 'ETCO2', 'reason': 'mild_range_violation'}
Received data:  {'signal_value': 35.60000228881836, 'time_recorded': 2680.564299583435, 'caseid': 634, 'category': 'BT', 'reason': 'mild_range_violation'}
Received data:  {'signal_value': 35.60000228881836, 'time_recorded': 2682.564299583435, 'caseid': 634, 'category': 'BT', 'reason': 'mild_range_violation'}
Received data:  {'signal_value': 35.60000228881836, 'time_recorded': 2684.5633001327515, 'caseid': 634, 'category': 'BT', 'reason': 'mild_range_violation'}
Received data:  {'signal_value': 35.60000228881836, 'time_recorded': 2686.5633001327515, 'caseid': 634, 'category': 'BT', 'reason': 'mild_range_violation'}
Received data:  {'signal_value': 26.0, 'time_recorded': 871.285, 'caseid': 634, 'category': 'ETCO2', 'reason': 'mild_range_violation'}
This is the data we received from the devices. Analyse them and say what's the issue. and what is the severity level(negligible, moderate, high, urgent)"""
